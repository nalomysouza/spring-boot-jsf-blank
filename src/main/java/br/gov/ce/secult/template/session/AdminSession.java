package br.gov.ce.secult.template.session;
 ...
 *
 * By default it is always logged in so to have this feature one
 * must @Specializes this bean and put the security logic in IsLoggedIn method.
 */
@SessionScoped
public class AdminSession implements Serializable {
	...
	// avoid multiple redirects when redirecting user back to previous page after
	// session expiration
